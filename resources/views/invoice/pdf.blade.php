...
<head>
    ...
    <style>
        ...
        /* Unicode font – supports ALL currencies */
        @font-face {
...
<body>
  <div class="container">
    ...
    <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
      <thead>
        <tr>
          <th style="font-size: 14px; border-top: 1px solid #000; border-bottom: 1px solid #000; padding: 8px; text-align: left;">Items</th>
          ...
          <th style="font-size: 14px; border-top: 1px solid #000; border-bottom: 1px solid #000; padding: 8px; text-align: left;">Tax</th>
          <th style="font-size: 14px; border-top: 1px solid #000; border-bottom: 1px solid #000; padding: 8px; text-align: left;">Total</th>
        </tr>
      </thead>
      <tbody>
        ...
        <tr>
          ...
          <td style="border: none; padding: 8px; font-size: 14px">{{ \App\CentralLogics\Helpers::formatCurrency($item->unit_price, $settings) }}</td>
          <td style="border: none; padding: 8px; font-size: 14px">{{ number_format($item->unit_tax, 2) }}% {{$item->quantity==1?'(Incl.)':'(Excl.)'}}</td>
    ...
    <div class="footer">
      ...
      <p>Created At: {{ now()->format('Y-m-d H:i:s') }}</p>
      </br>
